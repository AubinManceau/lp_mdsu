        ...
        <header className="bg-blanc border-b border-gray-100 py-4 px-4 sm:px-6 lg:px-8">
            <div className="container mx-auto flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-8 lg:gap-12">
                    {/* Using 'a' tags or just text for now as no router seems set up/requested specifically with links */}
                ...
                {/* Right Icons */}
                <div className="flex items-center gap-4 sm:gap-6 text-gris-dark">
                    {/* Search Icon */}
                    <button className="hover:text-rouge transition-colors">
